...
![TraCE21ka historical tsmx](figures/vign2_load_tsmx_trace.png)
...
![TraCE21ka historical tsmn](figures/vign2_load_tsmn_trace.png)
...
![TraCE21ka historical ts](figures/vign2_load_ts_trace.png)
...
![TraCE21ka historical pr](figures/vign2_load_pr_trace.png)
...
![TraCE21ka historical rhum](figures/vign2_load_rhum_trace.png)
...
![TraCE21ka historical cld](figures/vign2_load_cld_trace.png)
...
![TraCE21ka historical ps](figures/vign2_load_ps_trace.png)
...
![TraCE21ka historical u](figures/vign2_load_u_trace.png)
...
![TraCE21ka historical v](figures/vign2_load_v_trace.png)
...
![TraCE21ka historical wss](figures/vign2_load_wss_trace.png)
...
![TraCE21ka historical](figures/vign2_combine_historical_trace.png)
...
![UERRA tasmin](figures/vign2_load_tsmn_uerra.png)
...
```
![UERRA tas](figures/vign2_load_ts_uerra.png)
...
![UERRA tasmax](figures/vign2_load_tsmx_uerra.png)
...
![UERRA pr](figures/vign2_load_pr_uerra.png) 
...
![UERRA rhum](figures/vign2_load_rhum_uerra.png) 
...
![UERRA ps](figures/vign2_load_ps_uerra.png) 
...
![UERRA cld](figures/vign2_load_cld_uerra.png) 
...
![UERRA wss](figures/vign2_load_wss_uerra.png) 
...
```{r load_tasmin_cmip} 
cmip.tasmin <- loadeR::loadGridData("Data/CMIP5/rcp2.6/CESM1-CAM5_RCP_2_6/tasmin_Amon_CESM1-CAM5_rcp26_r1i1p1_200601-210012.nc", var = "tasmin", lonLim = trace.lon, latLim = trace.lat, dictionary = "Data/CMIP5/dictionary.dic")
...
![CMIP5 tasmin](figures/vign2_load_tsmn_cmip5.png)

#### TAS

```{r load_tas_cmip} 
cmip.tas <- loadeR::loadGridData("Data/CMIP5/rcp2.6/CESM1-CAM5_RCP_2_6/tasmax_Amon_CESM1-CAM5_rcp26_r1i1p1_200601-210012.nc", var = "tas", lonLim = trace.lon, latLim = trace.lat, dictionary="Data/CMIP5/dictionary.dic")

visualizeR::spatialPlot(transformeR::climatology(cmip.tas), main="tas", backdrop.theme="countries", rev.colors=TRUE, at=seq(-15,40,1))
```
![CMIP5 tas](figures/vign2_load_ts_cmip5.png)

#### TASMAX

```{r load_tasmax_cmip} 
cmip.tasmax <- loadeR::loadGridData("Data/CMIP5/rcp2.6/CESM1-CAM5_RCP_2_6/tasmax_Amon_CESM1-CAM5_rcp26_r1i1p1_200601-210012.nc", var = "tasmax", lonLim = trace.lon, latLim = trace.lat, dictionary="Data/CMIP5/dictionary.dic")
...
![CMIP5 tasmax](figures/vign2_load_tsmx_cmip5.png)


#### PR

```{r load_pr_cmip} 
cmip.pr <- loadeR::loadGridData("Data/CMIP5/rcp2.6/CESM1-CAM5_RCP_2_6/pr_Amon_CESM1-CAM5_rcp26_r1i1p1_200601-210012.nc", var = "pr", lonLim = trace.lon, latLim = trace.lat, dictionary = "Data/CMIP5/dictionary.dic")
...
![CMIP5 pr](figures/vign2_load_pr_cmip5.png) 

#### HURS

```{r load_hurs_cmip} 
cmip.hurs <- loadeR::loadGridData("Data/CMIP5/rcp2.6/CESM1-CAM5_RCP_2_6/hurs_Amon_CESM1-CAM5_rcp26_r1i1p1_200601-210012.nc", var = "hurs", lonLim = trace.lon, latLim = trace.lat, dictionary = "Data/CMIP5/dictionary.dic")

visualizeR::spatialPlot(transformeR::climatology(cmip.hurs), main="hurs", backdrop.theme="countries", rev.colors=TRUE)
```

![CMIP5 rhum](figures/vign2_load_rhum_cmip5.png) 


#### PS

```{r load_ps_cmip} 
cmip.ps <- loadeR::loadGridData("Data/CMIP5/rcp2.6/CESM1-CAM5_RCP_2_6/ps_Amon_CESM1-CAM5_rcp26_r1i1p1_200601-210012.nc", var = "ps", lonLim = trace.lon, latLim = trace.lat, dictionary = "Data/CMIP5/dictionary.dic")

visualizeR::spatialPlot(transformeR::climatology(cmip.ps), main="ps", backdrop.theme="countries", rev.colors=TRUE)
```

![CMIP5 ps](figures/vign2_load_ps_cmip5.png) 

#### CLD

```{r load_cld_cmip} 
cmip.cld <- loadeR::loadGridData("Data/CMIP5/rcp2.6/CESM1-CAM5_RCP_2_6/clt_Amon_CESM1-CAM5_rcp26_r1i1p1_200601-210012.nc", var = "cld", lonLim = trace.lon, latLim = trace.lat, dictionary = "Data/CMIP5/dictionary.dic")

visualizeR::spatialPlot(transformeR::climatology(cmip.cld), main="cld", backdrop.theme="countries", rev.colors=TRUE)
```

![CMIP5 cld](figures/vign2_load_cld_cmip5.png) 


#### WSS

```{r load_wss_cmip} 
cmip.wss <- loadeR::loadGridData("Data/CMIP5/rcp2.6/CESM1-CAM5_RCP_2_6/sfcWind_Amon_CESM1-CAM5_rcp26_r1i1p1_200601-210012.nc", var = "wss", lonLim = trace.lon, latLim = trace.lat, dictionary = "Data/CMIP5/dictionary.dic")

visualizeR::spatialPlot(transformeR::climatology(cmip.wss), main="wss", backdrop.theme="countries", rev.colors=TRUE)
```

![CMIP5 wss](figures/vign2_load_wss_cmip5.png) 
