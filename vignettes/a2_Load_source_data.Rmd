...
Original TraCE21ka data are in NetCDF format. However, they have several characteristics that makes not straightforward to import them using function from the [loadeR] package. 
