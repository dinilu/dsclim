---
title: "2. Model calibration and cross validation"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{2. Model calibration and cross validation}
...
```{r calculate_accuracy_metrics, eval=FALSE}
...
```{r map_biasses_2, eval=FALSE, echo=FALSE}
