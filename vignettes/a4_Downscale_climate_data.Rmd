...
# spatial.pars <- list(which.combine = NULL,
                        v.exp = .95,
                        rot = FALSE)
...
```{r prepare_data}
data = prepareData(hist.trace, uerra, local.predictors = local.pars, spatial.predictors = spatial.pars)
...
downscaleTrace(1 , "output/", "../../Data/TraCE21ka/", mod_data = data, model = model, global_nc_attributes = global.nc.attributes)
```
