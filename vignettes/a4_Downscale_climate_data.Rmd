...
```{r prepare_data}
data = prepareData(hist.trace, uerra.tasmin, spatial.predictors = spatial.pars)
```
...
dowscaleCMIP5(uerra.tasmin, cmip5.rcps[[1]], cmip5.mods[[1]], indir = "../../Data/CMIP5/", outdir = "prueba/CMIP5/", local.var, spatial.pars = spatial.pars, method = "GLM", family.link, global.nc.attributes)
