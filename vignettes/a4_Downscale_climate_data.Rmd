...
mapply(downscaleCMIP5, df[,1], df[,2], MoreArgs = list(indir = "../../Data/CMIP5/", uerra = uerra, outdir = "prueba/CMIP5/", method = "GLM", family.link = "gaussian", spatial_pars = spatial.pars, global_nc_attributes = global.nc.attributes))
```
